...
// OpenSslDecryptor is used to decrypt strings that were encrypted with openssl.
...
// NewOpenSslDecryptor creates a new OpenSslDecryptor, loading the passphrase for decrypting
// secrets from the file provided. Whitespace is stripped from the start and end of the file.
...
// If there is an error decrypting, the original string is returned.
